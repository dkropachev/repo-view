...
The fixed artifact-manifest v3 contains a closed set of exact executable roles:
Codex, scopesifter, static verifier Git, and 14 native utilities. It
...
The command interpreter is not a bundle artifact. Snapshot construction copies
