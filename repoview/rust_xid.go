...
// Code generated from unicode-ident 1.0.24 (Unicode 17.0.0). DO NOT EDIT.
// See ../THIRD_PARTY_NOTICES.md for source and license notices.

type rustXIDRange struct{ first, last rune }

var rustXIDStartRanges = [...]rustXIDRange{
...
var rustXIDContinueRanges = [...]rustXIDRange{
...
func rustRuneInXIDRanges(value rune, ranges []rustXIDRange) bool {
	...
	return left < len(ranges) && ranges[left].first <= value
}
